...
class DonHangDaMua extends StatefulWidget {
  @override
  DonHangDaMuaState createState() => DonHangDaMuaState();
}

class DonHangDaMuaState extends State<DonHangDaMua> {
  ...
  List<Order> _filterOrders(List<Order> orders) {
    return orders.where((order) => order.trangThai == "DaGiao").toList();
  }
