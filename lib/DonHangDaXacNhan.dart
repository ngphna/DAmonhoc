...
class DonHangDaXacNhan extends StatefulWidget {
  @override
  DonHangDaXacNhanState createState() => DonHangDaXacNhanState();
}

class DonHangDaXacNhanState extends State<DonHangDaXacNhan> {
  ...
  List<Order> _filterOrders(List<Order> orders) {
    return orders.where((order) => order.trangThai == "DaXacNhan").toList();
  }
